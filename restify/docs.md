...
No
#### FILTERING & ORDERING:
List of all properties can be filtered and sorted by using GET parameters. Endpoint localhost:8000/properties/retrieve/all/?<filter/order>=<value>&<filter/order>=<value>
