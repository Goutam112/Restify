...
No
#### FILTERING & ORDERING:
List of all properties can be filtered and sorted by using GET parameters. Endpoint localhost:8000/properties/retrieve/all/?<filter/order>=<val>&<filter/order>=<val>
